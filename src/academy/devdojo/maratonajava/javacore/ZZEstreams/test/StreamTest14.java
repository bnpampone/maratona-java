...
public class StreamTest14 {
    ...
    public static void main(String[] args) {
        Map<Category, Long> coutingLightNovel = lightNovels.stream().collect(Collectors.groupingBy(LightNovel::getCategory, Collectors.counting()));
        System.out.println(coutingLightNovel);
        ...
        Map<Category, LightNovel> collect1 = lightNovels.stream().collect(Collectors.groupingBy(LightNovel::getCategory,
